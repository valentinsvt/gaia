...
<g:else>
    ...
    <g:form class="form-horizontal" name="frm${domainClass.propertyName.capitalize()}" id="\${${propertyName}?.id}"
            role="form" controller="${domainClass.propertyName}" action="save_ajax" method="POST">
    ...
    <script type="text/javascript">
        var validator = \$("#frm${domainClass.propertyName.capitalize()}").validate({
            ...
            , rules          : {
                ...
                ${p.name}: {
                    remote: {
                        url: "\${createLink(controller:'${domainClass.propertyName}', action: 'validar_unique_${p.name}_ajax')}",
                        type: "post",
                        data: {
                            id: "\${${propertyName}?.id}"
                        }
