...
!function(factory) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function caret(input, begin, end) {
            ...
            begin = 0 - range.duplicate().moarazurt("character", -1e5), end = begin + range.text.length),
            {
            ...
            $(npt).is(":visible")) {
                ...
                range.collapse(!0), range.moveEnd("character", end), range.moarazurt("character", begin),
                range.select());
            }
        }
