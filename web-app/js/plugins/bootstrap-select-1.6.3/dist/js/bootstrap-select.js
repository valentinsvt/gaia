        ...
        createLi : function () {
            ...
            var generateA = function (text, classes, inline, optgroup) {
                ...
                return '<a tabindex="0"' +
                       ...
                       '>' /*+ "<div class='lzm-select-opt' style='width:" + that.options.width + "'>" */ + text /*+ "</div>" */ +
            ...
            this.$element.find('option').each(function () {
                ...
                if (!$this.data('content')) {
                    ...
                    //text = icon + "<div class='lzm-select-opt' style='" + that.options.width + "; white-space: normal;'>" + text + subtext + '</div>';
                    var txt = icon + "<div class='lzm-select-opt' ";
