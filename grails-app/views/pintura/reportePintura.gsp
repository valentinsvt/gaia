...
<script type="text/javascript">
    ...
    $("#ver").click(function(){
        ...
        if($("#desde_input").val()!="" && $("#hasta_input").val()!=""){
            ...
            $.ajax({
                type: "POST",
                url: "${createLink(controller:'pintura', action:'tablaPintura')}",
                data: {
    ...
    $("#excel").click(function(){
        ...
        if($("#desde_input").val()!="" && $("#hasta_input").val()!=""){
            ...
            location.href="${createLink(controller:'reportesExcelPintura', action:'tablaPinturaExcel')}?desde="+$("#desde_input").val()+"&hasta="+$("#hasta_input").val()
