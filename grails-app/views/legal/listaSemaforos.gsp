...
<head>
    ...
    <title>Contratos por estación</title>
...
<body>
<elm:container tipo="horizontal" titulo="Contratos por estación">
    ...
    <table class="table table-striped table-hover table-bordered" style="margin-top: 15px;font-size: 12px">
        ...
        <g:each in="${dash}" var="d" status="">
            ...
            <tr data-id="${d.estacion.codigo}" class=" tr-info  ${color[1]}  ">
                ...
                <td class="td-semaforo">
                    <a href="${g.createLink(controller: 'legal',action: 'showEstacion',id: d.estacion.codigo)}" class="btn btn-primary btn-sm" title="Ver"><i class="fa fa-search"></i></a>
                </td>
