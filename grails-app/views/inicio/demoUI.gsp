...
<html lang="en">
    ...
    <body role="document">
        ...
        <div class="container theme-showcase" role="main">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-left">
                        <div class="lzm-tab-heading">
                            <a href="#">Entrada</a>
                        </div>

                        <div class="lzm-tab-body">
                            Content area nada
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-left lzm-tab-primary">
                        <div class="lzm-tab-heading">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-right lzm-tab-success">
                        <div class="lzm-tab-heading">
                            <a href="#">Home</a>
                            <a href="#" class="selected">Projects</a>
                            <a href="#">About</a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-info">
                        <div class="lzm-tab-heading">
                            <a href="#">Home</a>
                            <a href="#" class="selected">Projects</a>
                            <a href="#">About</a>
                ...
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-right lzm-tab-warning">
                        <div class="lzm-tab-heading">
                            <a href="#">Home</a>
                            <a href="#" class="selected">Projects</a>
                            <a href="#">About</a>
                ...
                <div class="col-md-4">
                    <div class="lzm-tab lzm-tab-right lzm-tab-danger">
                        <div class="lzm-tab-heading">
                            <a href="#">Home</a>
                            <a href="#" class="selected">Projects</a>
                            <a href="#">About</a>
            ...
            <div class="lzm-note alert alert-success alert-dismissible" role="alert">
            ...
            <div class="lzm-note alert alert-info" role="alert">
            ...
            <div class="lzm-note alert alert-warning" role="alert">
                <strong>Warning!</strong> Best check yo self, you're not looking too good.
            </div>

            <div class="lzm-note alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert">
                    <span aria-hidden="true">&times;</span><span class="sr-only">Close</span>
                </button>
            ...
            <div class="page-header">
                <h1>lzm-notes Right</h1>
            </div>

            <div class="lzm-note-right alert alert-success alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert">
                    <span aria-hidden="true">&times;</span><span class="sr-only">Close</span>
                </button>
                %{--<h4>Title</h4>--}%
            ...
            <div class="lzm-note-right alert alert-info" role="alert">
                <strong>Heads up!</strong> This alert needs your attention, but it's not super important.
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas tincidunt lacinia lacus, at placerat ipsum euismod vitae. Pellentesque ac mollis felis, eget congue nulla. Integer efficitur ex sed lorem euismod, sit amet accumsan ante molestie. Quisque rutrum, nisi nec tempor blandit, arcu ante semper turpis, sit amet viverra metus sem nec lectus. Mauris aliquam dui eros. Nunc vitae blandit lacus. Proin ullamcorper dictum nunc. Sed sed risus id justo ornare feugiat. Donec efficitur mi quis leo bibendum, ut molestie risus condimentum. Ut ex risus, luctus eu ipsum nec, condimentum accumsan dolor.
                </p>
            ...
            <div class="lzm-note-right alert alert-warning" role="alert">
                <strong>Warning!</strong> Best check yo self, you're not looking too good.
            </div>

            <div class="lzm-note-right alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert">
                    <span aria-hidden="true">&times;</span><span class="sr-only">Close</span>
                </button>
                <strong>Oh snap!</strong> Change a few things up and try submitting again.
