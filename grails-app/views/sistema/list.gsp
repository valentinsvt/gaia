                ...
                <g:if test="${sistemaInstanceCount > 0}">
                    <g:each in="${sistemaInstanceList}" status="i" var="sistemaInstance">
                        <tr data-id="${sistemaInstance.id}">
                            ...
                            <td>${sistemaInstance.nombre}</td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${sistemaInstance}" field="descripcion"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${sistemaInstance}" field="codigo"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${sistemaInstance}" field="imagen"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${sistemaInstance}" field="controlador"/></elm:textoBusqueda></td>
