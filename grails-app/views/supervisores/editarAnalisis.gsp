...
<elm:container tipo="horizontal" titulo="Análisis de ventas del supervisor: ${session.usuario}">
    <fieldset style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ${ventasActual-ventasAnterior > 0?'':'-'}<g:formatNumber number="${ventasActual-ventasAnterior}" type="currency" currencySymbol="\$ "></g:formatNumber>
                <g:if test="${ventasAnterior > 0}">
                    <span style="margin-left: 40px">${((ventasActual*100/ventasAnterior)-100).toDouble().round(2)}%</span>
                </g:if>
                <g:else>
