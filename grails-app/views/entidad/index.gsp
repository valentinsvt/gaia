		...
		<div id="list-entidad" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'entidad.codigo.label', default: 'Codigo')}" />
				...
				<g:each in="${entidadInstanceList}" status="i" var="entidadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${entidadInstance.id}">${fieldValue(bean: entidadInstance, field: "nombre")}</g:link></td>
					
						<td>${fieldValue(bean: entidadInstance, field: "codigo")}</td>
