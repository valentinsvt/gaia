		...
		<div id="list-dependencia" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'dependencia.codigo.label', default: 'Codigo')}" />
				...
				<g:each in="${dependenciaInstanceList}" status="i" var="dependenciaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: dependenciaInstance, field: "codigo")}</td>
			...
			<div class="pagination">
				<g:paginate total="${dependenciaInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
